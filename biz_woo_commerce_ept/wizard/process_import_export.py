...
class WooProcessImportExport(models.TransientModel):
    ...
    def execute(self):
        ...
        """
        queues = False
        actions = {"import_customer": ["biz_woo_commerce_ept.woo_customer_data_queue_ept_action",
                                       "biz_woo_commerce_ept.woo_customer_data_data_queue_ept_form_view"],
                   "import_product": ["biz_woo_commerce_ept.action_woo_product_data_queue_ept",
                                      "biz_woo_commerce_ept.woo_product_data_queue_form_view_ept"],
                   "import_unshipped_orders": ["biz_woo_commerce_ept.action_woo_unshipped_order_queue_ept",
                                               "biz_woo_commerce_ept.view_woo_order_data_queue_ept_form"],
                   "import_completed_orders": ["biz_woo_commerce_ept.action_woo_shipped_order_queue_ept",
                                               "biz_woo_commerce_ept.view_woo_order_data_queue_ept_form"],
                   "import_coupon": ["biz_woo_commerce_ept.action_woo_coupon_data_queue_ept",
                                     "biz_woo_commerce_ept.view_woo_coupon_data_queue_ept_form"]}
    ...
    def preapre_template_vals_from_csv_data(self, record, instance_id, product_type):
        ...
        if self.env["ir.config_parameter"].sudo().get_param("biz_woo_commerce_ept.set_sales_description"):
    ...
    def woo_check_running_schedulers(self, cron_xml_id):
        ...
        """
        try:
            cron_id = self.env.ref('biz_woo_commerce_ept.%s%d' % (cron_xml_id, self.woo_instance_id.id))
        except Exception as error:
            return
